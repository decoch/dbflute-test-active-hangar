...
/**
 * The simple DTO of SubDirectoryCheck. <br>
 * <pre>
 * [primary-key]
 *     
 * 
...
public abstract class BsSubDirectoryCheckDto implements Serializable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSubDirectoryCheckDto)) { return false; }
        final BsSubDirectoryCheckDto otherEntity = (BsSubDirectoryCheckDto)other;
    ...
    public int hashCode() {
        int result = 17;
        result = xCH(result, "SubDirectoryCheck");
