...
public abstract class BsPurchase extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    /**
     * [get] MEMBER_LOGIN by my MEMBER_ID, named 'memberLoginAsBizManyToOne'. <br>
     * Optional: alwaysPresent(), ifPresent().orElse(), get(), ...
    ...
    /**
     * [set] MEMBER_LOGIN by my MEMBER_ID, named 'memberLoginAsBizManyToOne'.
    ...
    /**
     * [get] WHITE_DATE_TERM by my , named 'whiteDateTermAsValid'. <br>
     * Optional: alwaysPresent(), ifPresent().orElse(), get(), ...
    ...
    public OptionalEntity<WhiteDateTerm> getWhiteDateTermAsValid() {
        if (_whiteDateTermAsValid == null) { _whiteDateTermAsValid = OptionalEntity.relationEmpty(this, "whiteDateTermAsValid"); }
