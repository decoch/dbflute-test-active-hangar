...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberServiceId = cci("MEMBER_SERVICE_ID", "MEMBER_SERVICE_ID", null, "会員サービスID", Integer.class, "memberServiceId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_4C2072A0_CDCF_49C1_A9CA_114B734EC18E", false, null, "独立した主キーとなるが、実質的に会員IDとは one-to-one である。", null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.hanger.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.hanger.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.hanger.dbflute.exbhv.MemberServiceBhv"; }
