...
public class RegionDbm extends AbstractDBMeta {
    ...
    protected final TableSqlName _tableSqlName = new TableSqlName("MAIHAMADB.PUBLIC.REGION", _tableDbName);
    ...
    protected final ColumnInfo _columnRegionName = cci("REGION_NAME", "REGION_NAME", null, "地域名称", String.class, "regionName", null, false, false, true, "VARCHAR", 50, 0, null, false, null, "地域を漠然と表す名称。", null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.hanger.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.hanger.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.hanger.dbflute.exbhv.RegionBhv"; }
