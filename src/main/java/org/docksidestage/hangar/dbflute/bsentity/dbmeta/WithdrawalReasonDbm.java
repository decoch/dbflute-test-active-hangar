...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnWithdrawalReasonText = cci("WITHDRAWAL_REASON_TEXT", "WITHDRAWAL_REASON_TEXT", null, "退会理由テキスト", String.class, "withdrawalReasonText", null, false, false, true, "CLOB", 2147483647, 0, null, null, false, null, "退会理由の内容。\nテキスト形式なので目いっぱい書けるが、そうするとUI側できれいに見せるのが大変でしょうね。", null, null, null, false);
