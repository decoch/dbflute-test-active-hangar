...
public abstract class BsPaymentCompletePurchase extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.hangar.dbflute.bsentity.customize.dbmeta.PaymentCompletePurchaseDbm.getInstance();
    }
    ...
    /**
     * [set] PURCHASE_DATETIME: {TIMESTAMP(23, 10), refers to PURCHASE.PURCHASE_DATETIME} <br>
