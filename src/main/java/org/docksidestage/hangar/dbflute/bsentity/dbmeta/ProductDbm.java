...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, Integer.class, "productId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_FD58201D_6746_4BD0_BA19_A594E66F933B", false, null, null, null, "purchaseList", null, false);
    ...
    protected final ColumnInfo _columnProductHandleCode = cci("PRODUCT_HANDLE_CODE", "PRODUCT_HANDLE_CODE", null, "商品ハンドルコード", String.class, "productHandleCode", null, false, false, true, "VARCHAR", 100, 0, null, false, null, "これだけは書いておこう、商品を識別する業務上のコード。よく品番とか言うかもしれませんねぇ...", null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.hanger.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.hanger.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.hanger.dbflute.exbhv.ProductBhv"; }
