...
public abstract class AbstractBsWhiteDateTermCQ extends AbstractConditionQuery {
     ...
     */
    public HpSLCFunction<WhiteDateTermCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, WhiteDateTermCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteDateTermCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, WhiteDateTermCB.class);
    }
    ...
    public HpSLCFunction<WhiteDateTermCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, WhiteDateTermCB.class);
    }
    ...
    public HpSLCFunction<WhiteDateTermCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, WhiteDateTermCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteDateTermCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, WhiteDateTermCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<WhiteDateTermCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, WhiteDateTermCB.class);
    }
