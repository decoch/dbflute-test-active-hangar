...
public class BsVendorPrimaryKeyOnlyCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<VendorPrimaryKeyOnlyCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<VendorPrimaryKeyOnlyCB> unionCBLambda) {
        final VendorPrimaryKeyOnlyCB cb = new VendorPrimaryKeyOnlyCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<VendorPrimaryKeyOnlyCQ> {
         ...
         */
        public SpecifiedColumn columnPrimaryKeyOnlyId() { return doColumn("PRIMARY_KEY_ONLY_ID"); }
     ...
     */
    public HpColQyOperand<VendorPrimaryKeyOnlyCB> columnQuery(final SpecifyQuery<VendorPrimaryKeyOnlyCB> colCBLambda) {
     ...
     */
    public void orScopeQuery(OrQuery<VendorPrimaryKeyOnlyCB> orCBLambda) {
        xorSQ((VendorPrimaryKeyOnlyCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<VendorPrimaryKeyOnlyCB> andCBLambda) {
        xorSQAP((VendorPrimaryKeyOnlyCB)this, andCBLambda);
    }
