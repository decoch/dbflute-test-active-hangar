...
public class BsOptionMemberPmb implements ListHandlingPmb<MemberBhv, OptionMember>, EntityHandlingPmb<MemberBhv, OptionMember>, FetchBean {
    ...
    /** The parameter of birthdate:fromDate|ref(MEMBER.BIRTHDATE) :: refers to BIRTHDATE: {DATE(8)}. */
    ...
    protected List<org.docksidestage.hangar.dbflute.allcommon.CDef.MemberStatus> _statusList;
    ...
    /**
     * [get] birthdate:fromDate|ref(MEMBER.BIRTHDATE) :: refers to BIRTHDATE: {DATE(8)} <br>
     * // several options
    ...
    /**
     * [set as fromDate] birthdate:fromDate|ref(MEMBER.BIRTHDATE) :: refers to BIRTHDATE: {DATE(8)} <br>
     * // several options
     ...
     */
    public List<org.docksidestage.hangar.dbflute.allcommon.CDef.MemberStatus> getStatusList() {
        return _statusList;
    }
     ...
     */
    public void setStatusList(List<org.docksidestage.hangar.dbflute.allcommon.CDef.MemberStatus> statusList) {
