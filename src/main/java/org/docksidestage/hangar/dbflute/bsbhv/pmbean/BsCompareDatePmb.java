package org.docksidestage.hangar.dbflute.bsbhv.pmbean;
...
public class BsCompareDatePmb implements ExecuteHandlingPmb<MemberBhv>, FetchBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of memberId:ref(MEMBER) :: refers to MEMBER_ID: {PK, ID, NotNull, INTEGER(10)}. */
    protected Integer _memberId;

    /** The parameter of birthdateFrom:ref(MEMBER.BIRTHDATE) :: refers to BIRTHDATE: {DATE(8)}. */
    protected java.time.LocalDate _birthdateFrom;

    /** The parameter of formalizedDatetimeFrom:ref(MEMBER.FORMALIZED_DATETIME) :: refers to FORMALIZED_DATETIME: {IX, TIMESTAMP(23, 10)}. */
    ...
    //                                                                            ========
    /**
     * [get] memberId:ref(MEMBER) :: refers to MEMBER_ID: {PK, ID, NotNull, INTEGER(10)} <br>
    ...
    /**
     * [set] memberId:ref(MEMBER) :: refers to MEMBER_ID: {PK, ID, NotNull, INTEGER(10)} <br>
    ...
    /**
     * [get] birthdateFrom:ref(MEMBER.BIRTHDATE) :: refers to BIRTHDATE: {DATE(8)} <br>
    ...
    /**
     * [set] birthdateFrom:ref(MEMBER.BIRTHDATE) :: refers to BIRTHDATE: {DATE(8)} <br>
    ...
    /**
     * [get] formalizedDatetimeFrom:ref(MEMBER.FORMALIZED_DATETIME) :: refers to FORMALIZED_DATETIME: {IX, TIMESTAMP(23, 10)} <br>
    ...
    /**
     * [set] formalizedDatetimeFrom:ref(MEMBER.FORMALIZED_DATETIME) :: refers to FORMALIZED_DATETIME: {IX, TIMESTAMP(23, 10)} <br>
