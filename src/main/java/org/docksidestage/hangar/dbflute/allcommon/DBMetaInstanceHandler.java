...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("MEMBER", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("MEMBER_ADDRESS", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("MEMBER_FOLLOWING", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("MEMBER_LOGIN", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("MEMBER_SECURITY", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("MEMBER_SERVICE", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("MEMBER_STATUS", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("MEMBER_WITHDRAWAL", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("PRODUCT", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("PRODUCT_CATEGORY", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("PRODUCT_STATUS", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("PURCHASE", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("PURCHASE_PAYMENT", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("REGION", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("SERVICE_RANK", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("SUMMARY_PRODUCT", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.SummaryProductDbm");
        tmpMap.put("SUMMARY_WITHDRAWAL", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.SummaryWithdrawalDbm");
        tmpMap.put("VENDOR_$_DOLLAR", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.Vendor$DollarDbm");
        tmpMap.put("VENDOR_CHECK", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.VendorCheckDbm");
        tmpMap.put("VENDOR_IDENTITY_ONLY", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.VendorIdentityOnlyDbm");
        tmpMap.put("VENDOR_PRIMARY_KEY_ONLY", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.VendorPrimaryKeyOnlyDbm");
        tmpMap.put("VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnDbm");
        tmpMap.put("VENDOR_THE_LONG_AND_WINDING_TABLE_AND_COLUMN_REF", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.VendorTheLongAndWindingTableAndColumnRefDbm");
        tmpMap.put("WHITE_DATE_TERM", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.WhiteDateTermDbm");
        tmpMap.put("WITHDRAWAL_REASON", "org.docksidestage.hanger.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
